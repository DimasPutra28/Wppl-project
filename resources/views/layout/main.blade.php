...
<body>
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color: #FFFFFF">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top" style="background-color: #FFFFFF">
                <a class="sidebar-brand brand-logo" href="index.html" style="background-color: black"><img src="assets/images/logo.svg"
                        alt="logo" /></a>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row ">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title" style="display: flex; justify-content: center;">DATA OBAT APOSEHX
                                    </h4>
                                    @yield('wppl')
                                    @yield('wwppll')
                                </div>
